...
const rakutenButtonVariants = cva(
  "inline-flex items-center justify-center gap-2 font-semibold transition-all focus-visible:outline-none disabled:pointer-events-none disabled:opacity-42 relative overflow-hidden",
  {
    variants: {
      type: {
        "primary-red":
          "bg-[#BF0000] text-white hover:bg-[#BF0000]/95 active:bg-[#BF0000]",
        "primary-black":
          "bg-black text-white hover:bg-black/95 active:bg-black",
        "primary-white":
          "bg-white text-black hover:bg-white/95 active:bg-white",
        "secondary-contained":
          "bg-transparent text-black hover:bg-black/4 active:bg-black/4 dark:text-white dark:hover:bg-white/8 dark:active:bg-white/8",
        "tertiary-text":
          "bg-transparent text-[#BF0000] hover:bg-[#FCF2F2] active:bg-[#FCF2F2]",
        "tertiary-text-subtle":
          "bg-transparent text-black hover:bg-black/4 active:bg-black/4 dark:text-white dark:hover:bg-white/8 dark:active:bg-white/8",
        "tertiary-underlined-text":
          "bg-transparent text-[#BF0000] underline hover:bg-[#FCF2F2] active:bg-[#FCF2F2]",
        "tertiary-underlined-text-subtle":
          "bg-transparent text-black underline hover:bg-black/4 active:bg-black/4 dark:text-white dark:hover:bg-white/8 dark:active:bg-white/8",
      },
      size: {
    ...
    compoundVariants: [
      {
        type: "primary-red",
        className:
          "focus-visible:ring-4 focus-visible:ring-black focus-visible:ring-offset-2 focus-visible:ring-offset-white",
      },
      {
        type: "primary-black",
        className:
      ...
      },
      {
        type: "primary-white",
        className:
          "focus-visible:ring-4 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-black",
      },
      {
        iconPosition: "only",
        size: "small",
...
const ChevronRightIcon = ({
  ...
  >
    <path
      d="M10.03 18.53L8.97 17.47L14.44 12L8.97 6.52997L10.03 5.46997L16.56 12L10.03 18.53Z"
      fill={fill}
    />
  </svg>
);
...
const LoadingSpinner = ({
  ...
  >
    <path
      d="M11 2C12.1819 2 13.3522 2.23279 14.4442 2.68508C15.5361 3.13738 16.5282 3.80031 17.364 4.63604C18.1997 5.47177 18.8626 6.46392 19.3149 7.55585C19.7672 8.64778 20 9.8181 20 11"
      stroke={stroke}
      strokeWidth="4"
    />
  </svg>
...
const RakutenButton = React.forwardRef<HTMLButtonElement, RakutenButtonProps>(
  (
    ...
    const getIconFill = () => {
      ...
      if (type === "tertiary-text" || type === "tertiary-underlined-text")
        return "#BF0000";
      return "currentColor";
    };
    ...
    const getSpinnerStroke = () => {
      if (type === "primary-red" || type === "primary-black") return "white";
      if (type === "primary-white" || type === "secondary-contained")
        return "black";
      return "currentColor";
    };
