...
const defaultItems: ProductShowcaseItem[] = [
  {
    ...
    subtitle: "Shirt",
    image:
      "https://api.builder.io/api/v1/image/assets/TEMP/4679e81e7ec467524065876aaae3dae152685276?width=950",
    alt: "The Linen Shirt",
  ...
  },
  {
    ...
    subtitle: "Dress",
    image:
      "https://api.builder.io/api/v1/image/assets/TEMP/647eb1248778d0f1e7ea8bcfb6ccb5ea2dfa323f?width=950",
    alt: "The White Dress",
  ...
  },
  {
    ...
    subtitle: "Bag",
    image:
      "https://api.builder.io/api/v1/image/assets/TEMP/b844558521324ac08a9af04837b5172cbd506f00?width=950",
    alt: "The Wicker Bag",
